...
function getLifeBar() {
    ...
    return new Array(Math.round(plein)).fill(barCompleteChar).join('') + '     ' +
        new Array(Math.round(vide)).fill(barIncompleteChar).join('') + percent
}
...
setInterval(function() {
    const space = [
        ...
        '',
        getAge() + ' / ' + 'Press M for eat' + ' / ' + 'Press F for fun'+ ' / ' + 'Press d to get drunk',
        '',
        getPastis()
    ]
